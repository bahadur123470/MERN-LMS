...
const CallToAction = () => {
    return (
        <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
            ...
            <p className='text-gray-500 sm:text-sm'>Join thousands of learners who’ve transformed their skills with us. 
                <br />Start your journey today and see the difference for yourself!</p>
